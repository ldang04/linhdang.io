        ...
        <CSSTransition in={show} timeout={1000} classNames="fade-slide" unmountOnExit>
            <div className="about-container">
                ...
                <div className="about-text">
                    ...
                    <p>
                    I’m an undergrad at Columbia & an AI/ML fellow at Cornell’s Break Through Tech program. With a love for tech, startup culture, and ethics, I am passionate about leveraging technology for social good. I also love <a href="https://devpost.com/dangdiemlinh04">hacking</a>, <a href="https://www.instagram.com/crochetedlines/">crocheting</a>, and poring over Murakami's latest novels.
                    </p>
                </div>
            </div>
        </CSSTransition>
