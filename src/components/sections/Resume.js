        ...
        <CSSTransition in={show} timeout={1000} classNames="fade-slide" unmountOnExit>
            <div className="resume-container">
                <div className="polaroid-container">
                    ...
                    <p>You can find my detailed resume <a href="https://docs.google.com/document/d/1skdxXlAGNm5yGmMDdG8loVhrRDKCJuhb/pub" target="_blank" rel="noopener noreferrer">here</a>.</p>
                </div>
            </div>
    </CSSTransition>
    )
